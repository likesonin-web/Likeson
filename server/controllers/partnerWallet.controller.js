...
// PATCH '/bank-accounts/:bankId/set-primary'
export const patchBankAccountsByBankIdSetPrimary = asyncHandler(async (req, res) => {
...
export const deleteBankAccountsByBankId = asyncHandler(async (req, res) => {
    const { bankId } = req.params;
...
// PATCH '/admin/wallets/:walletId/status'
export const patchAdminWalletsByWalletIdStatus = asyncHandler(async (req, res) => {
...
// PATCH '/admin/wallets/:walletId/kyc-status'
export const patchAdminWalletsByWalletIdKycStatus = asyncHandler(async (req, res) => {
...
// PATCH '/admin/wallets/:walletId/hold'
export const patchAdminWalletsByWalletIdHold = asyncHandler(async (req, res) => {
...
// PATCH '/admin/bank-accounts/:walletId/:bankId/verify'
export const patchAdminBankAccountsByWalletIdByBankIdVerify = asyncHandler(async (req, res) => {
