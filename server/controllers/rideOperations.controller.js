...
export const getRidesByRideIdParticipants = asyncHandler(async (req, res) => {
    try {
...
// POST '/rides/:rideId/participants'
export const postRidesByRideIdParticipants = asyncHandler(async (req, res) => {
    try {
      const { rideId } = req.params;
...
// PATCH '/rides/:rideId/participants/:participantId/status'
export const patchRidesByRideIdParticipantsByParticipantIdStatus = asyncHandler(async (req, res) => {
    try {
...
// POST '/admin/bookings/:bookingId/join-point'
export const postAdminBookingsByBookingIdJoinPoint = asyncHandler(async (req, res) => {
    try {
...
// GET '/rides/:rideId/join-points'
export const getRidesByRideIdJoinPoints = asyncHandler(async (req, res) => {
    try {
      const { rideId } = req.params;
      if (!isValidId(rideId))
        return res.status(400).json({ success: false, message: 'Invalid rideId' });
...
// PATCH '/rides/:rideId/join-points/:jpId/status'
export const patchRidesByRideIdJoinPointsByJpIdStatus = asyncHandler(async (req, res) => {
    try {
...
export const getRidesByRideIdStops = asyncHandler(async (req, res) => {
    try {
      const { rideId } = req.params;
      if (!isValidId(rideId))
        return res.status(400).json({ success: false, message: 'Invalid rideId' });
...
// PATCH '/rides/:rideId/stops/:stopId/otp'
export const patchRidesByRideIdStopsByStopIdOtp = asyncHandler(async (req, res) => {
    try {
...
// PATCH '/rides/:rideId/stops/:stopId/status'
export const patchRidesByRideIdStopsByStopIdStatus = asyncHandler(async (req, res) => {
    try {
      const { rideId, stopId } = req.params;
      const { status, lat, lng } = req.body;
...
// GET '/rides/:rideId/route-versions'
export const getRidesByRideIdRouteVersions = asyncHandler(async (req, res) => {
    try {
      const { rideId } = req.params;
      if (!isValidId(rideId))
        return res.status(400).json({ success: false, message: 'Invalid rideId' });
...
// POST '/bookings/:bookingId/sos'
export const postBookingsByBookingIdSos = asyncHandler(async (req, res) => {
    try {
      const { bookingId } = req.params;
...
// GET '/bookings/:bookingId/sos'
export const getBookingsByBookingIdSos = asyncHandler(async (req, res) => {
    try {
      const { bookingId } = req.params;
      if (!isValidId(bookingId))
        return res.status(400).json({ success: false, message: 'Invalid bookingId' });
...
export const patchSosBySosIdResolve = asyncHandler(async (req, res) => {
    try {
...
// PATCH '/admin/bookings/:bookingId/destination'
export const patchAdminBookingsByBookingIdDestination = asyncHandler(async (req, res) => {
    try {
      const { bookingId } = req.params;
...
// GET '/admin/bookings/:bookingId/destination-history'
export const getAdminBookingsByBookingIdDestinationHistory = asyncHandler(async (req, res) => {
    try {
      const { bookingId } = req.params;
      if (!isValidId(bookingId))
        return res.status(400).json({ success: false, message: 'Invalid bookingId' });
...
// PATCH '/admin/rides/:rideId/replace-vehicle'
export const patchAdminRidesByRideIdReplaceVehicle = asyncHandler(async (req, res) => {
    try {
      const { rideId } = req.params;
...
// PATCH '/admin/rides/:rideId/replace-vehicle'
export const patchAdminRidesByRideIdReplaceVehicle2 = asyncHandler(async (req, res) => {
    try {
      const { rideId } = req.params;
      const { newVehicleId, reason } = req.body;
...
// GET '/rides/:rideId/assignment-history'
export const getRidesByRideIdAssignmentHistory = asyncHandler(async (req, res) => {
    try {
      const { rideId } = req.params;
      if (!isValidId(rideId))
        return res.status(400).json({ success: false, message: 'Invalid rideId' });
...
export const getBookingsByBookingIdStatusHistory = asyncHandler(async (req, res) => {
    try {
      const { bookingId } = req.params;
      if (!isValidId(bookingId))
        return res.status(400).json({ success: false, message: 'Invalid bookingId' });
...
// GET '/bookings/:bookingId/assignment-history'
export const getBookingsByBookingIdAssignmentHistory = asyncHandler(async (req, res) => {
    try {
      const { bookingId } = req.params;
      if (!isValidId(bookingId))
        return res.status(400).json({ success: false, message: 'Invalid bookingId' });
...
// GET '/rides/:rideId/stops/:stopId'
export const getRidesByRideIdStopsByStopId = asyncHandler(async (req, res) => {
    try {
      const { rideId, stopId } = req.params;
      if (!isValidId(rideId) || !isValidId(stopId))
...
// GET '/rides/:rideId/participants/:participantId'
export const getRidesByRideIdParticipantsByParticipantId = asyncHandler(async (req, res) => {
    try {
      const { rideId, participantId } = req.params;
      if (!isValidId(rideId) || !isValidId(participantId))
        return res.status(400).json({ success: false, message: 'Invalid id' });
...
// DELETE '/rides/:rideId/participants/:participantId'
export const deleteRidesByRideIdParticipantsByParticipantId = asyncHandler(async (req, res) => {
    try {
      const { rideId, participantId } = req.params;
...
// GET '/rides/:rideId/route-versions/active'
export const getRidesByRideIdRouteVersionsActive = asyncHandler(async (req, res) => {
    try {
      const { rideId } = req.params;
      if (!isValidId(rideId))
        return res.status(400).json({ success: false, message: 'Invalid rideId' });
...
// POST '/admin/bookings/:bookingId/join-point/recalc'
export const postAdminBookingsByBookingIdJoinPointRecalc = asyncHandler(async (req, res) => {
    try {
      const { bookingId } = req.params;
