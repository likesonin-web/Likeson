...
// POST '/redeem-coins'
export const postRedeemCoins = asyncHandler(async (req, res) => {
...
// GET '/validate/:code'
export const getValidateByCode = asyncHandler(async (req, res) => {
...
export const getAdminUserByUserId = asyncHandler(async (req, res) => {
...
export const postAdminManualAward = asyncHandler(async (req, res) => {
