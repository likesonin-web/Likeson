...
export default function PartnerTicketDetail() {
  ...
  return (
    <SupportShell breadcrumbs={[{ label: 'Support', href: '/hospital-manager/support' }, { label: 'Ticket' }]}>
      <TicketDetailPage ticketId={ticketId} backHref="/hospital-manager/support" currentUser={user} />
    </SupportShell>
  );
}
